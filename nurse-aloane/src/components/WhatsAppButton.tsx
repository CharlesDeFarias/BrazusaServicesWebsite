...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full bg-whatsapp py-3 pl-3 pr-4 text-white shadow-lg shadow-forest/30 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95 sm:bottom-7 sm:right-7"
    >
